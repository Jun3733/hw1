...
The goal of this assignment is to introduce you to R, RStudio, Git, and , which you'll be using throughout the course both to learn the data science concepts discussed in the course and to analyze real data and come to informed conclusions.
...
positive
means when one increase, the other will go increase at the same time
